...
> ⚠️ **历史文档（2026-09-07 标注）**：本文写于早期 GitHub Pages + SQLite + Windows 本机开发时期，部署相关内容已过时（现为 nginx 自托管 + PostgreSQL 单服务器部署）。当前权威文档：[17-系统架构文档](./17-系统架构文档.md)、[18-日常使用手册](./18-日常使用手册.md)。本文其余内容仅作背景参考。
